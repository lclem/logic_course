...
| 5 | 30.03 | Hilbert's proof system for first-order logic, soundness, completeness | expressing properties in first-order logic: spectrum (P2.8.2-2.8.9) and its closure properties (P2.8.10-13); infiniteness (P2.3.4-7) |
