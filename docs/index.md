...
| 2 | 09.03 | resolution (soundness, refutation completeness, hardness of pigeon-hole formulas, polynomial interpolants); SAT solving (DP, DPLL, phase transition); success of SAT solvers | P1.3.5 (self-reducibility of SAT), P1.4.3 (exponential lower bound on equivalent CNF), P1.7.2 (interpolation), P1.7.3 (Beth definability), P1.7.4 (infinite extension of interpolation), P1.7.6 (resolution yields polynomial interpolation) |
