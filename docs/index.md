...
| 2 | 09.03 | resolution (soundness, refutation completeness, hardness of pigeon-hole formulas); sat solving | P1.7.2 (interpolation), P1.7.3 (Beth definability), P1.7.4, resolution yields polynomial interpolation P1.7.6 |
