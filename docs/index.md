...
| 6 | 06.04 | intuitionistic first-order logic: tautology examples, natural deduction, dependent types, lambdaP1 calculus, Kripke models, negative translation | no new exercises (IFOL is studied in labs) |
| 7 | 13.04 | (EASTER) | 
